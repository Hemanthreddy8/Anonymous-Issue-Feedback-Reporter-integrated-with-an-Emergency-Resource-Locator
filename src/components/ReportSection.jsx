    ...
    <section className="panel">
      <header className="panel-header">
        <div>
          ...
          <p>Scope your report to a gated community, city, state, country, or global.</p>
        </div>
        <div className="privacy-banner">
          <span className="privacy-icon">🛡️</span>
          <span>
            <strong>Your privacy is protected.</strong> No IP addresses, device info, or personal
            data is collected.
          </span>
        </div>
      </header>
      ...
      <div className="panel-body report-layout">
        ...
        <div className="report-form">
          ...
          <div className="region-grid">
            ...
            <div className="field-group">
              <label className="field-label">Community / Campus</label>
              <input
                type="text"
                value={community}
          ...
          <div className="form-footer">
            <div className="form-tip">
              ...
              <span>
                Avoid full names or personal identifiers unless required for safety.
              </span>
            </div>
            <button
